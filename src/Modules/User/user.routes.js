...
import * as AV from "../Authentication/auth.validation.js";
...
router.post("/createUser",validation(AV.signUp),auth([systemRoles.admin,systemRoles.superAdmin]),UC.createUser)
